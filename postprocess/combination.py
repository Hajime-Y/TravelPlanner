...
if __name__ == '__main__':
    ...
    parser.add_argument("--agent_framework", type=str, default="smolagents", choices=["smolagents", "openai_agents", "langgraph", "pydanticai", "agno"], help="Agent framework used for generation.")
