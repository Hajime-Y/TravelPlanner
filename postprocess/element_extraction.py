...
if __name__ == '__main__':
    ...
    parser.add_argument("--agent_framework", type=str, default=None, choices=["smolagents", "openai_agents", "langgraph", "pydanticai", "agno"], help="Specify the agent framework used for sole-planning agent mode.")
